...
layout = html.Div([
    ...
    html.Div(
        [
            ...
            html.Img(
                src="http://www.nexteraenergy.com/neecommon/images/logo.png",
    ...
    # Graph: Show categorized downtimes?
    html.Div(
        [
            html.Div(
                [
                    dcc.Graph(id='dte-downtime-hrs-graph',
                              animate=False,
                              style={'margin-top': '20'})
